...
class StudentMasterController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
                 ...
                 $initial->session_id=$model->session_id;
                 $initial->save();
    ...
    public function actionSuccess($id,$adm)
    {
        return $this->render('success',['id'=>$id,'adm'=>$adm]);
    ...
    //     'content' =>$this->renderPartial('success',['id'=>$id,'adm_no'=>$adm]),
    //     'options' => [
    //         'title' => 'Labels',
