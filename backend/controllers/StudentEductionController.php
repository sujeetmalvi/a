...
use backend\models\StudentEductionSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * StudentEductionController implements the CRUD actions for StudentEducation model.
 */
class StudentEductionController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new StudentEductionSearch();
