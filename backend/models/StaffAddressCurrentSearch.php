...
/**
 * StaffAddressCurrentSearch represents the model behind the search form about `backend\models\StaffAddressCurrent`.
 */
class StaffAddressCurrentSearch extends StaffAddressCurrent
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = StaffAddressCurrent::find();
