...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2016 at 01:36 PM
...
INSERT INTO `addmission_payment_details` (`id`, `student_id`, `class_id`, `amt`, `pay_mode`, `pay_mode_detail`, `remarks`, `session_id`) VALUES
(1, 4, 1, '1167', 2, 'cash', 'njnjn', 1);
...
INSERT INTO `_fee_breakup` (`id`, `fee_type_id`, `name`, `amt`) VALUES
(1, 1, 'Admission', 4500),
(2, 1, 'security', 500);
